...
const RoomsPage = ({ data }) => (
  <Page>
    <Container>
      ...
      <Intro>
        <Img alt="Our Home" sizes={data.home.childImageSharp.fluid} />
        <Box my="2rem">
          <h2>Our Home</h2>
          <p>
            Located just outside the old city centre, and only a short walk to
            the Saturday and Sunday night markets. We welcome you to come stay
            with us at our Thai house. All rooms have mosquito nets, individual
            fans and a private locker for each person. Free coffee, tea, and
            drinking water are available in the common area; alcohol and
            soft-drinks can be purchased from the staff bar.
          </p>
        </Box>
      </Intro>
      ...
      <RoomDetails>
        <div>
          <Img alt="Dorm Room" sizes={data.dorm.childImageSharp.fluid} />
          <Box mt="2rem">
            <h2>Dorm Room</h2>
            <p>
              Single bed.
        ...
        <div>
          <Img alt="Private Room" sizes={data.twin.childImageSharp.fluid} />
          <Box mt="2rem">
            <h2>Private Rooms</h2>
            <p>
      ...
      <h2>Gallery</h2>
      <Gallery
        data={data.gallery.edges.map(({ node }) => node.childImageSharp.fluid)}
      />
    </Container>
  </Page>
);
